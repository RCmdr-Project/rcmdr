...
%\VignetteIndexEntry{Iniciación a R Commander}
...
Por favor, dirija la correspondencia al mantendor actual Manuel Munoz-Marquez \href{mailto:manuel.munoz@uca.es}{\texttt{manuel.munoz@uca.es}}}\\ (Getting Started With the R Commander)}
