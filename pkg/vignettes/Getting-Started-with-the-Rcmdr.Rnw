...
\title{Getting Started With the R Commander\thanks{Parts of this manual are adapted and updated from Fox (2005).
Please address correspondence to current mantainer Manuel Munoz-Marquez \texttt{manuel.munoz@uca.es}. }}
\author{John Fox}
